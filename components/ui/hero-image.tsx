  ...
  return (
    <div className="relative flex items-center justify-center mt-5">
      <div className="flex justify-center items-center gap-4">
        {/*Ballot Paper*/}
        <div className="w-20 h-20 z-10  bg-white/10 rounded-full shadow-xl backdrop-blur-sm border border-white/30 items-center justify-center text-gray-800 font-semibold flex flex-col will-change-transform">
          <LiaVoteYeaSolid className="text-5xl text-[#978AE5] size-[50px]" />
        </div>
        {/*Shield Paper*/}
        <div className="w-30 h-30 z-20  bg-white/10 rounded-full shadow-xl backdrop-blur-md border border-white/30 items-center justify-center text-gray-800 font-semibold flex flex-col will-change-transform -mr-12 p-2">
      ...
      <div className="w-96 h-96 z-10  bg-white/10 rounded-full shadow-xl backdrop-blur-sm border border-white/30 items-center justify-center text-gray-800 font-semibold flex flex-col will-change-transform">
        {/* Embossed fingerprint container with multiple shadow layers */}
        <div className="relative w-64 h-64 rounded-full flex justify-center items-center">
          {/* Outer glow ring */}
          ...
          <div className="relative w-60 h-60 rounded-full bg-gradient-to-br from-gray-100 via-gray-50 to-gray-200 shadow-[inset_0_2px_8px_rgba(0,0,0,0.1),inset_0_-2px_8px_rgba(255,255,255,0.8),0_8px_32px_rgba(0,0,0,0.1),0_2px_8px_rgba(0,0,0,0.05)] border border-white/50 flex items-center justify-center overflow-hidden">
      ...
      <div className="flex justify-center items-center gap-4">
        {/*Links*/}
        <div className="w-30 h-30 z-20  bg-white/10 rounded-full shadow-xl backdrop-blur-md border border-white/30 items-center justify-center text-gray-800 font-semibold flex flex-col will-change-transform -ml-12 p-2">
          <div className="size-full bg-white/10 rounded-full shadow-xl backdrop-blur-sm border border-white/30 items-center justify-center text-gray-800 font-semibold flex flex-col will-change-transform ">
